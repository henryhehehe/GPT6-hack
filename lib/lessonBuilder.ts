...
export const GeneratedLessonSchema=WorldSchema.omit({settingImage:true,museumObjectIds:true,sceneAppearance:true}).extend({lessonPack:LessonPackSchema.omit({curriculum:true})});
