...
import {reserveQuotaSql,quotaLimit,aiDisabledMessage} from './pilotPolicy';
...
export function requireImages(){throw new Error('New image generation is turned off for this pilot. Existing illustrations remain available.');}
