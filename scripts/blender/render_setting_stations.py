...
Export placements first with scripts/export-setting-layout.mjs, then run Blender
...
scene.camera = camera
scene.render.filepath = str(REPO / 'assets/blender/setting-stations-preview.png')
