...
type Props={remainingCharacters?:number;error?:string;saving?:boolean;settingImageUrl?:string|null;imported?:boolean;evidence:Evidence|null;collected:boolean;student:boolean;busy:boolean;onClose:()=>void;onCollect:()=>Promise<void>;onUse:(citation:string)=>void};
...
export default function EvidenceReader({remainingCharacters=1600,error='',saving=false,settingImageUrl,imported=false,evidence,collected,student,busy,onClose,onCollect,onUse}:Props){
