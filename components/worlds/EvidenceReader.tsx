...
type Props={evidence:Evidence|null;collected:boolean;student:boolean;busy:boolean;onClose:()=>void;onCollect:()=>Promise<void>;onUse:(citation:string)=>void};
...
export default function EvidenceReader({evidence,collected,student,busy,onClose,onCollect,onUse}:Props){
