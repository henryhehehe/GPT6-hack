...
type Props={open:boolean;initialWorldId?:string;className?:string;onClose:()=>void;onChoose:(lessonId:string)=>void};

export default function LessonCatalog({open,initialWorldId,className,onClose,onChoose}:Props){
 ...
 return <Dialog open={open} onOpenChange={value=>{if(!value)onClose();}}>
  <DialogContent className={"lesson-catalog"+(className?" "+className:"")}>
